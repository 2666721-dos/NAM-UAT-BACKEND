    ...
    try:
        ...
        if not input:
            ...
            dt = [
                ...
                "【追加ルール：原文一致性チェック】",
                "Org_Text と Input の内容が大きく異なる場合（語彙・主語・要因など）には、チェックを中止し、空文字（\"\")を返してください。",
                "このチェックは Result に依存せず、文章内容の類似度に基づいて行います。",
                "Input が Org_Text と明らかに異なる文意・要因・主語を含む場合は、以降の Result 比較ルールを適用せず、出力は空文字とします。",
