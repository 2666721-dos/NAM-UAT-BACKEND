    ...
    try:
        ...
        if not input:
            ...
            dt = [
                ...
                "Referenceに特定の年月（例：2025年8月）の記載がある場合、Result内の「年」と「月」の両方が一致するデータのみを使用してください（例：「2025年8月」なら「2025/08/◯◯」）。他の月の値を参照してはなりません。",
                "また、Referenceに年月指定がある場合、差分計算はその月と直前月の値のみを使用してください。他の月を使ってはいけません。",
